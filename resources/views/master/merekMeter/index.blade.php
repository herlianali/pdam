                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('printmerekMeter') }}" class="btn btn-xs btn-success float-right"><i class="fas fa-print"></i> Cetak </a>
                        </div>
                        <div class="card-body">
                            <div class="row mb-4">
                                <div class="col-md-8">
                                    <form class="form-horizontal" action="{{ route('merekMeter.index') }}" method="POST">
                                        ...
                                        <div class="form-group row mt-2">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <button type="reset" class="btn btn-danger btn-sm mt-3">

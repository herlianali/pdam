...
@section('title', 'Print Status Meter')
...
@section('breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active">Print Status Meter</li>
    </ol>
@endsection
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('cetakstatusMeter') }}" class="btn btn-sm btn-success float-right print">Print</a>
                        </div>
                        <div class="card-body priview">
                            ...
                            <div class="mx-auto mb-3" style="width: 250px;">
                                <span>
                                    <center> TABEL MASTER STATUS METER </center>
                                </span> <br>
                            </div>
                            <table class="table">
                                <thead>
...
<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script type="text/javascript">
        ...
        $(document).on('click', '.print', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: `{{ url('master/cetakstatusMeter') }}`,
                dataType: 'html',
                data: {
                    _token: '{{ csrf_token() }}',
                },
                ...
                success: function(res){
                    var w = window.open(`{{ url('master/cetakstatusMeter') }}`,'_blank');
                    w.document.open();

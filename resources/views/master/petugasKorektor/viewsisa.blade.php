...
@section('breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active">View Sisa Random Penugasan</li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">View Sisa Random Penugasan</h3>
                        </div>
                        <div class="card-body">
                            <div class="row mb-4">
                                <div class="col-md-12">
                                    <form class="form-horizontal">
                                        <div class="form-group row mt-2">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" id="thbl" name="thbl" onkeyup="valueing()">
                                            </div>
                                        </div>
                                        <div class="form-group row mt-2">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" id="tgl_penugasan" name="tgl_penugasan" onkeyup="valueing()">
                                            </div>
                                        </div>
                                        <div class="form-group row mt-2">
                                    ...
                                    <form>
                                        <div class="form-group row mt-2 ">
                                            ...
                                            <div class="col-md-4">
                                                <select class="form-control" id="ptgs_korektor" name="ptgs_korektor" onkeyup="valueing()">
                                        ...
                                        <div class="form-group row mt-2">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <button class="btn btn-success btn-sm" type="submit"><i
                                                        class="far fa-save"></i> Hapus Petugas</button>
                                                <br>
                                                <input type="checkbox">
                                                <label for="" class="col-md-2 col-form-label">Kirim Petugas</label>
                                                <button class="btn btn-success btn-sm" type="submit"><i
                                                        class="far fa-save"></i> Kirim Petugas</button>
                                            </div>
                                        </div>
                                    </form>

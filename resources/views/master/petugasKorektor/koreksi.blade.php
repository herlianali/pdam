                ...
                <div class="row mb-4">
                    <div class="col-md-12">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group row mt-2">
                                ...
                                <div class="col-md-3">
                                    <input type="date" class="form-control" id="tgl_penugasan"
                                        name="tgl_penugasan"onkeyup="valueing()">
                                </div>
                            </div>
                            <div class="form-group row mt-2">
                    ...
                    <table id="table" class="table table-bordered table-responsive-md table-condensed">
                        ...
                        <tbody>
                            ...
                            <td>1</td>
                            <td>
                                <button type="submit" class="btn btn-xs btn-danger "><i class="fas fa-trash-alt"></i>
                                    Hapus</button>

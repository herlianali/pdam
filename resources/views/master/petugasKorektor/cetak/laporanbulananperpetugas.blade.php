...
@section('title', 'Laporan Bulanan per Petugas')
...
@section('breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active">Laporan Bulanan per Petugas</li>
    </ol>
    <br>
    <br>
    <button type="submit"
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Laporan Bulanan per Petugas</h3>

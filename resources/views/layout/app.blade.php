...
<head>
  ...
  <!-- css extend with blade templating -->
  <link rel="stylesheet" href="{{ asset('assets/style.css') }}">
  @stack('css')

</head>
<body class="sidebar-mini sidebar-collapse accent-primary">
<div class="wrapper">

  <!-- Preloader -->
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ asset('assets/img/logo.png') }}" alt="{{ config('app.name') }}Logo" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar elevation-4 sidebar-light-indigo">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Wilayah Timur</span>
    </a>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="staticBackdropLabel">Log menu</h5>
...
<!-- js extend with blade templating -->
@stack('js')
</body>
</html>

...
<form action="">
    ...
    <div class="form-group row mt-2 ">
            <label for="no_pelanggan" class="col-md-3 col-form-label">Tgl Entry</label>
                            ...
                            <input type="checkbox">
                            <label for="potensial" class="col-md-2 col-form-label">Cetak Rekap</label>
                            <br>
            </div>
            <div class="form-group row mt-2 ">
                <label for="no_pelanggan" class="col-md-3 col-form-label">No Pelanggan</label>
                                ...
                                <label for="no_pelanggan" class="col-form-label">Tgl Surat</label>
                                <div class="col-md-2">
                                    <input type="text" class="form-control" id="no_pelanggan" name="no_pelanggan" onkeyup="valueing()">
                                </div>
    ...
    <div class="form-group row mt-2 ">
        ...
        <div class="col-md-2">
            <select class="form-control" id="wilayah" onkeyup="valueing()">
                <option value="wilayah T"> </option>
                <option value="wilayah B">  </option>
            </select>
            </div>
    </div>
    <div class="form-group row mt-2 ">

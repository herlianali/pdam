...
@section('breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active">Edit Monitoring BA Mutasi Kolektif</li>
    </ol>
@endsection
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Edit Monitoring BA Mutasi Kolektif</h3>
                            <a href="{{ route('cetakUsulanmonitoringBAMutasiKolektif') }}"
                                class="btn btn-xs btn-info float-right"><i class="fas fa-print"></i> Cetak Usulan</a>
                            <a href="{{ route('pdinasmonitoringBAMutasiKolektif') }}"
                                class="btn btn-xs btn-info float-right"><i class="fas fa-print"></i> Panggilan Dinas</a>
                            <a href="{{ route('cetakLampiranmonitoringBAMutasiKolektif') }}"
                                class="btn btn-xs btn-info float-right"><i class="fas fa-print"></i> Cetak Lampiran</a>
                        </div>
                        <div class="card-body">
                            <form class="form-horizontal" action="" method="post">
                                ...
                                <div class="form-group row mt-2 ">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="col ml-3">
                                                <div class="col">
                                                    <input type="radio" class="form-check-input" id="konektor"
                                                        name="jabatan">
                                ...
                                <div class="form-group row mt-2 ">
                                    ...
                                    <label for="nip" class="col-md-2 col-form-label">Terhitung Mulai</label>
                                    <div class="col-md-2">
                                        <input type="date" class="form-control" name="nip" id="nip"
                                            onkeyup="valueing()">
                                    </div>

                                    <label for="nama" class="col-md-2 col-form-label">Bulan Terbit </label>
                                    <div class="col-md-2">
                                        <input type="date" class="form-control" name="nip" id="nip"
                                            onkeyup="valueing()">
                                    </div>
                                ...
                                <div class="form-group row mt-2 ">
                                    ...
                                    <label for="nip" class="col-md-2 col-form-label">Tanggal Kasie</label>
                                    <div class="col-md-2">
                                        <input type="date" class="form-control" name="nip" id="nip"
                                            onkeyup="valueing()">
                                    </div>

                                    <label for="nama" class="col-md-2 col-form-label">Tanggal Kabag </label>
                                    <div class="col-md-2">
                                        <input type="date" class="form-control" name="nip" id="nip"
                                            onkeyup="valueing()">
                                    </div>

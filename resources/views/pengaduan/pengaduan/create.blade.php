                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-md-2">
                                                <input type="text" class="form-control" id="tlp_pengadu"
                                                    name="tlp_pengadu" onkeyup="valueing()">
                                            </div>
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-md-4">
                                            <input type="date" class="form-control" id="tgl_pengaduan"
                                                name="tgl_pengaduan" onkeyup="valueing()">
                                        </div>
                                    </div>
                                    <div class="form-group row ">
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" class="form-control" id="usulan_no_bonc"
                                                name="usulan_no_bonc" onkeyup="valueing()">
                                        </div>
                                    </div>
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" class="form-control" id="usulan_bonc_mtr"
                                                name="usulan_bonc_mtr" onkeyup="valueing()">
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <button type="submit" class=" btn-danger btn-sm float-right"><i class="fas fa-undo"></i>
                                Batal</button>
                            <button class=" btn-success btn-sm float-right" type="submit"><i class="far fa-save"></i>
                                Simpan</button>
                        </div>
                    </div>
                </div>
